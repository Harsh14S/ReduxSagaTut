...
export default UserFeedbackHeader = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.mid}>
        <Text style={styles.headingTxt}>Feedback</Text>
      </Pressable>

      <Pressable style={styles.right} onPress={() => { }}>
        <Image source={IconUri.QuerryIcon} style={styles.rightIcon} resizeMode={'contain'} />
      </Pressable>
    </View >
  )
}
